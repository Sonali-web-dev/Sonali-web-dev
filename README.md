<!-- README for Sonali-web-dev/Sonali-web-dev -->
...
<!-- Pure inline SVG animated gradient text — zero external dependencies -->
<svg width="700" height="60" xmlns="http://www.w3.org/2000/svg">
  ...
  <rect width="700" height="60" fill="none"/>
  <text x="350" y="42" text-anchor="middle"
        font-family="Segoe UI, Arial, sans-serif"
        font-size="19" font-weight="700"
        fill="url(#g1)">
    👩‍💻 Final-Year B.Tech | Full Stack MERN Developer | Oracle Cloud Certified
  </text>
</svg>
...
<img align="right" alt="Female Developer" width="310" src="https://user-images.githubusercontent.com/74038190/229223263-cf2e4b07-2615-4f87-9c38-e37600f8381a.gif"/>
...
💼  Goal       : Full Stack Developer / SDE
📍  Location   : Kanpur, Uttar Pradesh, India
📧  Email      : sonali.yv99@gmail.com
📄  Resume     : https://drive.google.com/file/d/1ufJSW0l5NHpvhBi3kiYnWpULILb7R9eT/view
```

- 🌱 Deepening expertise in **LLM Integration**, **REST API Security** & **Cloud Infrastructure**
- 💬 Ask me about **React.js · Node.js · Express.js · MongoDB · JWT · Gemini API**
...
- 🎯 Seeking **Full Stack / SDE roles** through campus placement 2027
...
Builds fast, accessible, mobile‑first interfaces with reusable component architecture and smooth scroll‑triggered animations.
...
Designs secure REST APIs with JWT‑based authentication, clean MVC structure, and 10+ third‑party API integrations.
...
Integrates LLM‑powered features (Gemini API) into production apps; OCI 2025 Foundations Associate certified.
...
<details>
<summary><b>📌 Click to expand full Core Skills breakdown</b></summary>
<br/>

| Domain | Skills | Proficiency |
|:---|:---|:---:|
| **Languages** | C++, Python, JavaScript (ES6+) | ⭐⭐⭐⭐ |
| **Frontend** | React.js, Context API, HTML5, CSS3, Bootstrap | ⭐⭐⭐⭐ |
| **Backend** | Node.js, Express.js, REST APIs, JWT Auth | ⭐⭐⭐⭐ |
| **Databases** | MongoDB Atlas, MySQL | ⭐⭐⭐ |
| **AI / LLM** | Google Gemini API, Prompt Engineering | ⭐⭐⭐ |
| **Cloud** | Oracle Cloud Infrastructure (OCI) | ⭐⭐⭐ |
| **DevOps & Tools** | Git, GitHub, Postman, Puppeteer, Multer, VS Code | ⭐⭐⭐⭐ |
| **CS Fundamentals** | DSA (150+ solved), OOP, DBMS, OS | ⭐⭐⭐⭐ |
...
![React](https://img.shields.io/badge/React-1e1b4b?style=for-the-badge&logo=react&logoColor=61DAFB)
![Context API](https://img.shields.io/badge/Context_API-1e1b4b?style=for-the-badge&logo=react&logoColor=61DAFB)
![Bootstrap](https://img.shields.io/badge/Bootstrap-1e1b4b?style=for-the-badge&logo=bootstrap&logoColor=A855F7)
![Responsive Design](https://img.shields.io/badge/Responsive_Design-1e1b4b?style=for-the-badge&logo=css3&logoColor=ec4899)
...
<details open>
<summary><b>🤖 AI-cruiter — AI-Powered Resume Analyzer & Interview Assistant</b></summary>
<br/>
...
| 🔌 APIs Integrated | **10+** |
| 📑 Resume Sections Analyzed | **5+ per request** |

A solo-built, full-stack platform that analyzes resumes and conducts AI-driven mock interviews using JWT-secured auth, Puppeteer-based scraping, and Gemini API for intelligent feedback.

🔗 **[View Repository →](https://github.com/Sonali-web-dev/AI-cruiter)**
...
| ⭐ **5-Star HackerRank** | C++ — Top tier rating |
...
&nbsp;
[![Resume](https://img.shields.io/badge/View_Resume-1e1b4b?style=for-the-badge&logo=googledrive&logoColor=A855F7)](https://drive.google.com/file/d/1ufJSW0l5NHpvhBi3kiYnWpULILb7R9eT/view?usp=drive_link)

<br/><br/>

<img src="https://capsule-render.vercel.app/api?type=waving&color=0:A855F7,50:6366f1,100:0f172a&height=120&section=footer&animation=twinkling" width="100%"/>
